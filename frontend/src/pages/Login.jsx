    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{backgroundColor: '#0F172A'}}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2" style={{color: '#64748B'}}>{t('welcomeBack')}</p>
        </div>

        <div className="rounded-2xl p-8" style={{backgroundColor: '#1E293B'}}>
          <h2 className="text-xl font-bold mb-6">{t('loginTitle')}</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-1" style={{color: '#64748B'}}>{t('email')}</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="block text-sm font-medium mb-1" style={{color: '#64748B'}}>{t('password')}</label>
              <input
                type="password"
                name="password"
          ...
          <p className="text-center mt-6 text-sm" style={{color: '#64748B'}}>
            {t('noAccount')}{' '}
            <Link to="/register" style={{color: '#FACC15'}}>{t('registerHere')}</Link>
          </p>
        </div>
      </div>
    </div>
